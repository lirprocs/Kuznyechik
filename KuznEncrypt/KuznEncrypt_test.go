...
func TestS(t *testing.T) {
	...
	for _, tt := range tests {
		res := S(tt.data)
		if res != tt.expected {
			t.Errorf("S() = %X; want %X", res, tt.expected)
		}
	}
}
...
func TestR(t *testing.T) {
	...
	for _, tt := range tests {
		res := R(tt.data)
		if res != tt.expected {
			t.Errorf("R() = %X; want %X", res, tt.expected)
		}
	}
}
...
func TestL(t *testing.T) {
	...
	for _, tt := range tests {
		res := L(tt.data)
		if res != tt.expected {
			t.Errorf("L() = %X; want %X", res, tt.expected)
		}
	}
}

func TestCipherText(t *testing.T) {
	expected := [16]byte{0x7F, 0x67, 0x9D, 0x90, 0xBE, 0xBC, 0x24, 0x30, 0x5A, 0x46, 0x8D, 0x42, 0xB9, 0xD4, 0xED, 0xCD}
	...
	res := Encrypt(plainText, keys)
	if res != expected {
		t.Errorf("L() = %X; want %X", res, expected)
	}
}
